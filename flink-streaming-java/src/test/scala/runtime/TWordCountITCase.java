...
// Checking input parameters
		final ParameterTool params = ParameterTool.fromArgs(new String[]{"--amma","abba", "--policy.rates.path","/home/danish/FastWorkspace/BDMA/TUB/ds2/ds2/controller/running-examples/wordcount/metrics_repo/"});
